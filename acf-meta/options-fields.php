    ...
    if (function_exists('acf_add_local_field_group')) {
        acf_add_local_field_group(array(
            ...
            'fields' => array(
                ...
                array(
                    'key' => 'field_mindbody_appointment_form_page',
                    'label' => 'Appointment Form',
                    'name' => 'mindbody_appointment_form_page',
                    'type' => 'page_link',
                    'instructions' => 'Select the page with the appointment form page.',
                    'required' => 1,
                    'post_type' => array('page'),
                    'allow_null' => 0,
                    'multiple' => 0,
                ...
                array(
                    'key' => 'field_mindbody_appointment_calendar_pager',
                    'label' => 'Appointment Calendar',
                    'name' => 'mindbody_appointment_calendar_page',
                    'type' => 'page_link',
                    'instructions' => 'Select the page with the appointment calendar page.',
                    'required' => 1,
                    'post_type' => array('page'),
                    'allow_null' => 0,
                    'multiple' => 0,
                ...
                array(
                    'key' => 'field_mindbody_appointment_success_page',
                    'label' => 'Appointment Success',
                    'name' => 'mindbody_appointment_success_page',
                    'type' => 'page_link',
                    'instructions' => 'Select the page to show after successful appointment.',
                    'required' => 1,
                    'post_type' => array('page'),
                    'allow_null' => 0,
                    'multiple' => 0,
