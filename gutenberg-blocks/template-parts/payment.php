...
$training_redirect_url = get_field('mindbody_calendar_page', 'option') . '?location=' . $location_id . '&siteId=' . $site_id . '&first_name=' . $first_name . '&last_name=' . $last_name . '&email=' . $email . '&phone=' . $phone . '&ads=' . $_GET['ads'];
